...
<div class="top-announcement">
  🔥 Limited Time: Get 10,000+ N8N Templates at ₹199 Only! &nbsp;|&nbsp; Instant Access + Lifetime Validity
</div>

<!-- SITE HEADER -->
<header class="site-header">
  <div class="container">
    <a href="#" class="brand">⚡ Smartskillsup</a>
    <div class="header-tagline">
      <strong>10,000+ N8N Templates</strong> · Save 1000+ Hours · Zero Coding Required
    </div>
    <a href="https://superprofile.bio/vp/ready-made-n8n-automation-templates-948" class="btn btn-primary" style="padding:10px 22px; font-size:0.88rem;">
      Get Templates →
    </a>
  </div>
</header>
...
<section class="hero">
  <div class="container">
    <div class="hero-left reveal">
      ...
      <a href="https://superprofile.bio/vp/ready-made-n8n-automation-templates-948" class="btn btn-primary btn-lg btn-pulse">
  ...
  <div class="container">
    <div class="included-grid reveal">
      <div>
        ...
        <br>
        <a href="https://superprofile.bio/vp/ready-made-n8n-automation-templates-948" class="btn btn-primary" style="margin-top:8px;">
...
<section class="how-it-works">
  <div class="container">
    ...
    <div style="text-align:center; margin-top:40px;">
      ...
      <a href="https://superprofile.bio/vp/ready-made-n8n-automation-templates-948" class="btn btn-primary">
...
<footer class="site-footer">
  <div class="container">
    <div class="footer-inner">
      <div class="footer-copy">Smartskillsup © 2026 · All Rights Reserved</div>
...
<div class="sticky-footer">
  ...
  <div class="sticky-footer-right">
    ...
    <a href="https://superprofile.bio/vp/ready-made-n8n-automation-templates-948" class="btn btn-primary btn-pulse" style="padding:12px 28px;">
